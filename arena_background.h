...
void create_images_window() {
    ...
    GdkPixbuf *image1 = gdk_pixbuf_new_from_file("E:\\ILISI_s1\\GTK\\Gladiator\\resourses\\arena7_button.png", NULL);
    GdkPixbuf *glad2 = gdk_pixbuf_new_from_file("E:\\ILISI_s1\\GTK\\Gladiator\\resourses\\arena5_button.png", NULL);
    GdkPixbuf *glad3 = gdk_pixbuf_new_from_file("E:\\ILISI_s1\\GTK\\Gladiator\\resourses\\arena6_button.png", NULL);
    GdkPixbuf *glad4 = gdk_pixbuf_new_from_file("E:\\ILISI_s1\\GTK\\Gladiator\\resourses\\arena8_button.png", NULL);
    ...
    g_signal_connect(button, "clicked", G_CALLBACK(on_images_start_button_click),"E:\\ILISI_s1\\GTK\\Gladiator\\resourses\\arena7.png");
    ...
    button = gtk_button_new();
    gtk_button_set_image(GTK_BUTTON(button), image_widget);
    g_signal_connect(button, "clicked", G_CALLBACK(on_images_start_button_click), "E:\\ILISI_s1\\GTK\\Gladiator\\resourses\\arena5.png");
    ...
    button = gtk_button_new();
    gtk_button_set_image(GTK_BUTTON(button), image_widget);
    g_signal_connect(button, "clicked", G_CALLBACK(on_images_start_button_click), "E:\\ILISI_s1\\GTK\\Gladiator\\resourses\\arena6.png");
    ...
    button = gtk_button_new();
    gtk_button_set_image(GTK_BUTTON(button), image_widget);
    g_signal_connect(button, "clicked", G_CALLBACK(on_images_start_button_click), "E:\\ILISI_s1\\GTK\\Gladiator\\resourses\\arena8.png");
