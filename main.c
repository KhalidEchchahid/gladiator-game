...
int main(int argc, char *argv[]) {
    ...
    Actor players[3] = {
            {
                    .name = "Samuri",
                    .sprite_sheet = "E:\\ILISI_s1\\GTK\\Gladiator\\resourses\\Samurai_Spritelist.png",
                    .image = "E:\\ILISI_s1\\GTK\\Gladiator\\resourses\\vector1.png",
                    .current_frame = 0,
                    .current_action = 0,
                    .action_frames = {
                            .standing = 6,
...

            {
                    ...
                    .image = "E:\\ILISI_s1\\GTK\\Gladiator\\resourses\\vector2.png",
                    .current_frame = 0,
                    .current_action = 0,
                    .action_frames = {
                            .standing = 7,
...

            {
                    ...
                    .image = "E:\\ILISI_s1\\GTK\\Gladiator\\resourses\\vector3.png",
                    .current_frame = 0,
                    .current_action = 0,
                    .action_frames = {
                            .standing = 1,
    ...
    Machine machines[2] = {
             {
                .sprite_sheet = "E:\\ILISI_s1\\GTK\\Gladiator\\resourses\\machine1.png",
                .image = "E:\\ILISI_s1\\GTK\\Gladiator\\resourses\\demon_idle_1.png",
                .current_frame = 0,
                .current_action = 0,
                .action_frames = {
                        .standing = 5,
             ...
             {
                .sprite_sheet = "E:\\ILISI_s1\\GTK\\Gladiator\\resourses\\Bringer-of-Death-SpritSheet.png",
                .image = "E:\\ILISI_s1\\GTK\\Gladiator\\resourses\\Bringer-of-Death_Idle_1.png",
                .current_frame = 0,
                .current_action = 0,
                .action_frames = {
                        .standing = 8,
    ...
    GtkWidget *player_machine_table = gtk_image_new_from_file("E:\\ILISI_s1\\GTK\\Gladiator\\resourses\\bg.png");
    gtk_fixed_put(GTK_FIXED(fixed), player_machine_table, background_image_width /2 + 200 , 20);
    GtkWidget *vs = gtk_image_new_from_file("E:\\ILISI_s1\\GTK\\Gladiator\\resourses\\vs.png");
    ...
    gtk_fixed_put(GTK_FIXED(fixed), button_create, background_image_width - 350, background_image_height - 325);
